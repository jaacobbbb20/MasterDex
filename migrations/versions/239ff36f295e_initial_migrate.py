...
Revision ID: 239ff36f295e
Revises: 
Create Date: 2025-08-24 05:46:25.046953
...
def upgrade():
    ...
    sa.Column('set_symbol', sa.String(), nullable=True),
    sa.Column('set_logo', sa.String(), nullable=True),
